...
<link
    ...
    integrity="sha512-01mG/8rtthZxcE/oLY/1aVBq0UHYxd3r9MgSi33zFQ190gj+BfHY8XeoFiErGyVt1pE68U6InjMq+xkVTSf6yg=="
...
<section>
    ...
    {#if selected_background}
        ...
        <Tags
            text={selected_background.tool_proficiencies
                ? selected_background.tool_proficiencies.split(',')
                : ['None']}
        />
        <h3>
...
<section>
    ...
    {#if selected_class}
        ...
        <span>
            <b>Hit Dice:</b>
            {selected_class.hit_dice}
        </span>
        <br />
        <span>
            <b>Armor Proficiencies:</b>
            <Tags text={selected_class.prof_armor.split(', ')} />
        </span>
        <br />
        <span>
            <b>Weapon Proficiencies:</b>
            <Tags text={selected_class.prof_weapons.split(', ')} />
        </span>
        <br />
