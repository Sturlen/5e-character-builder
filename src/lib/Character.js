...
export const Skills = {
    Acrobatics: {
        description:
            'You can attempt to perform acrobatic stunts or gymnastic feats, including dives, rolls, somersaults, and flips.'
    },
    'Animal Handling': {
        description:
            "You can calm down or train an animal, or even get it to do something it wouldn't normally do."
    },
    Arcana: {
        description:
            'You can recall lore about spells, magic items, eldritch symbols, magical traditions, the planes of existence, and the inhabitants of those planes.'
    },
    Athletics: {
    ...
    History: {
        description:
            'You have a good memory and can recall important historical events, people, and places.'
    },
    Insight: {
    ...
    Nature: {
        description:
            'You are knowledgeable about the natural world and can identify plants and animals, track creatures, and predict the weather.'
    },
    Perception: {
    ...
    Performance: {
        description:
            'You are skilled at entertaining others with music, dance, acting, storytelling, or some other form of performance.'
    },
    Persuasion: {
        description:
            'You are skilled at convincing others to do what you want, using charm, logic, or threats.'
    },
    Religion: {
        description:
            'You are knowledgeable about the religions of the world and can identify religious symbols and practices, as well as recall important religious events and people.'
    },
    'Sleight of Hand': {
        description:
            'You are skilled at pickpocketing, palming objects, and performing other feats of manual dexterity.'
    },
    Stealth: {
    ...
    Survival: {
        description:
            'You have experience living in the wilderness and can navigate through the natural world, find food and water, and track creatures.'
    }
}
